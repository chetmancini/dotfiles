...
export PATH=$HOME/bin:$JAVA_HOME/bin:$BUN_INSTALL/bin:$PNPM_HOME:$NPM_GLOBAL_BIN:$MYSQL_HOME:$UV_PATH:$ZEROBREW_PATH:$USR_LOCAL_HOME:$USR_LOCAL_SBIN:$NPM_PATH:$PERSONAL_BIN:$BREW_PATH:$MODULAR_HOME/bin:$WINDSURF_PATH:$NODE_PATH:$LMSTUDIO_PATH:$PATH
