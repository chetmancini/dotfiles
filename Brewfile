# Core Brewfile — install with: brew bundle --file=~/dotfiles/Brewfile
# Optional apps/tools: Brewfile.optional
...
brew "zsh-history-substring-search"  # Up/down substring history
